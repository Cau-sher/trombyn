...
$id_key_refinscriptf = getHTTPVars('id_key_refinscriptf', $HTTP_POST_VARS, $HTTP_GET_VARS);
$id_key_refinscriptc = getHTTPVars('id_key_refinscriptc', $HTTP_POST_VARS, $HTTP_GET_VARS);
$id_key_refinscriptp = getHTTPVars('id_key_refinscriptp', $HTTP_POST_VARS, $HTTP_GET_VARS);
$RefInscript = getHTTPVars('RefInscript', $HTTP_POST_VARS, $HTTP_GET_VARS);
