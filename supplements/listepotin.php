...
<table align="center" border="0">
    ...
    ?>
        <tr>
            <td align=center bgcolor="<?php	if ($ligne==1) { echo "F2F2F2"; } else {  echo "D6D6D6";  } ?>" width="10%"><font face="Trebuchet MS, Comic Sans MS" size=2><a><?php echo $val["Date"]; ?></a></font></td>
